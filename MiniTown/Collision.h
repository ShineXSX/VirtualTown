...
public:
	...
	// 视锥体裁剪
	static std::vector<Transformation> XM_CALLCONV FrustumCulling(
	...
	// 视锥体裁剪2
	static std::vector<Transformation> XM_CALLCONV FrustumCulling2(
		const std::vector<Transformation>& transforms, const DirectX::BoundingBox& localBox, DirectX::FXMMATRIX View, DirectX::CXMMATRIX Proj);
	// 视锥体裁剪3
	static std::vector<Transformation> XM_CALLCONV FrustumCulling3(
		const std::vector<Transformation>& transforms, const DirectX::BoundingBox& localBox, DirectX::FXMMATRIX View, DirectX::CXMMATRIX Proj);
