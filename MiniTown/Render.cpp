...
ComPtr<ID3D11RasterizerState> Render::RSNoCull			= nullptr;
ComPtr<ID3D11RasterizerState> Render::RSWireframe			= nullptr;
ComPtr<ID3D11RasterizerState> Render::RSCullClockWise		= nullptr;

ComPtr<ID3D11SamplerState> Render::SSAnistropicWrap		= nullptr;
ComPtr<ID3D11SamplerState> Render::SSLinearWrap			= nullptr;

ComPtr<ID3D11BlendState> Render::BSAlphaToCoverage		= nullptr;
ComPtr<ID3D11BlendState> Render::BSNoColorWrite			= nullptr;
ComPtr<ID3D11BlendState> Render::BSTransparent			= nullptr;
ComPtr<ID3D11BlendState> Render::BSAdditive				= nullptr;

ComPtr<ID3D11DepthStencilState> Render::DSSLessEqual		= nullptr;
ComPtr<ID3D11DepthStencilState> Render::DSSWriteStencil	= nullptr;
ComPtr<ID3D11DepthStencilState> Render::DSSDrawWithStencil= nullptr;
ComPtr<ID3D11DepthStencilState> Render::DSSNoDoubleBlend	= nullptr;
ComPtr<ID3D11DepthStencilState> Render::DSSNoDepthTest	= nullptr;
ComPtr<ID3D11DepthStencilState> Render::DSSNoDepthWrite	= nullptr;
ComPtr<ID3D11DepthStencilState> Render::DSSNoDepthTestWithStencil		= nullptr;
ComPtr<ID3D11DepthStencilState> Render::DSSNoDepthWriteWithStencil	= nullptr;
...
void Render::InitAll(ID3D11Device * device)
{
	// 先前初始化过的话就没必要重来了
	if (IsInit())
		return;
